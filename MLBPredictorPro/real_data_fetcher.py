    ...
    def calculate_predictions(self, player_stats: Dict, advanced_stats: Dict, player_type: str, player_id: int = None) -> Dict:
        ...
        try:
            if player_type == 'batter':
                ...
                # Calculate specific game predictions for pitcher
                ...
                # Predict per-game stats based on season averages
                avg_ks_per_game = strikeouts / games_started if games_started > 0 else 6.0
                avg_bb_per_game = walks / games_started if games_started > 0 else 3.0
                avg_hits_per_game = hits_allowed / games_started if games_started > 0 else 7.0
                avg_er_per_game = earned_runs / games_started if games_started > 0 else 3.0
